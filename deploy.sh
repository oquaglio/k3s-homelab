...
echo -e "${YELLOW}Step 8: Deploying n8n (Workflow Automation) via Helm...${NC}"
...
echo -e "${YELLOW}Step 9: Deploying C64 Emulator (for fun!)...${NC}"
...
echo -e "${YELLOW}Step 10: Deploying Code-Server (VS Code in browser)...${NC}"
