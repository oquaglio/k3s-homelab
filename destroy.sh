...
echo -e "${YELLOW}Step 8: Deleting Kubernetes Dashboard...${NC}"
...
echo -e "${YELLOW}Step 9: Deleting Portainer...${NC}"
...
echo -e "${YELLOW}Step 12: Deleting namespaces...${NC}"
