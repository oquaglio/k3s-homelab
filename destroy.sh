...
echo -e "${YELLOW}Step 13: Deleting Kubernetes Dashboard...${NC}"
...
echo -e "${YELLOW}Step 14: Deleting Portainer...${NC}"
...
echo -e "${YELLOW}Step 17: Deleting namespaces...${NC}"
