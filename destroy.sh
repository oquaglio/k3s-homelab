...
echo -e "${YELLOW}Step 10: Deleting Kubernetes Dashboard...${NC}"
...
echo -e "${YELLOW}Step 11: Deleting Portainer...${NC}"
...
echo -e "${YELLOW}Step 14: Deleting namespaces...${NC}"
