...
echo "========================================="
echo "K3s Homelab Installation Script"
echo "========================================="
echo ""
...
echo ""
echo -e "${YELLOW}Step 3: Installing Helm...${NC}"
...
echo ""
echo -e "${YELLOW}Step 4: Adding Helm repositories...${NC}"
...
echo -e "${GREEN}=========================================${NC}"
echo ""
echo "K3s, kubectl, and Helm are installed."
echo ""
echo "Next steps:"
echo "1. Run setup script: ./setup.sh"
echo "2. Create your secrets: cp secrets.sh.example secrets.sh && vi secrets.sh"
echo "3. Run secrets script: ./secrets.sh"
echo "4. Deploy applications: ./deploy.sh"